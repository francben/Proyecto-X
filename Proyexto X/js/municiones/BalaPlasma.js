function BalaPlasma(x, y, w, h, dx, dy){
	this.x = x;
	this.y = y;
	this.w = w;
	this.h = h;
	...
	this.dibujar = function(context){
		...
		brillo(context, 8/grilla*this.w,0,0,'fff');
		...
		circulo(context, this.x+2/grilla*this.w, this.y+4.5/grilla*this.h, 3/grilla*this.w, 0, Math.PI*2, true,'22f');
		context.restore();
	};
