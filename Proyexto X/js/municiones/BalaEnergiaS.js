function BalaEnergiaS(x, y, w, h, dx, dy){
	this.x = x;
	this.y = y;
	this.w = w;
	this.h = h;
	...
	this.dibujar = function(context){
		...
		brillo(context, 8/grilla*this.w,0,0,'ff0');
		...
		circulo(context, this.x+2/grilla*this.w, this.y+4.5/grilla*this.h, 3/grilla*this.w, 0, Math.PI*2, true,'f00');
		context.restore();
	};
